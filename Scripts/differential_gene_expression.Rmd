...
f3g <- upset(fromList(gene.lists),sets=c('Endothelial (0)','Microglia (1)','Oligodendrocyte (2)','Pericytes (3)','Astrocytes (4)',
      ...
      order.by='freq',keep.order=T,nintersects=35, text.scale=c(3, 2, 1.8, 2, 1.85, 1.3)) #c(intersection size title, intersection size tick labels, set size 
...
f3g <- upset(fromList(gene.lists),sets=c('cluster 0','cluster 1','cluster 2','cluster 3','cluster 4',
             ...
             set_size.show = FALSE, mainbar.y.label = "Number of Genes", 
      order.by='freq',keep.order=T,nintersects=35, text.scale=c(3, 2, 1.8, 2, 1.65, 1.3)) #c(intersection size title, intersection size tick labels, set size title, set size tick labels, set names, numbers above bars)
