...
p.opc <- ggplot(data=test, aes(x=time, y=OPC, group=treat)) +
  ...
  theme_bw() + xlab('Days') + ylab('Cell Type Proportion') +
  ggtitle('Oligodendrocyte Precursor') + theme(legend.position = 'none', axis.title=element_text(size=14), axis.text=element_text(size=12), plot.title=element_text(size=14)) +
  scale_color_manual(values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 

p.nipc <- ggplot(data=test, aes(x=time, y=nIPC, group=treat)) +
  geom_line(aes(col=treat), size=1.3) +
  theme_bw() + xlab('Days') + ylab('Cell Type Proportion') +
  ggtitle('Neuronal Intermediate Progenitor') + theme(legend.position = 'none', axis.title=element_text(size=14), axis.text=element_text(size=12), plot.title=element_text(size=14)) +
  scale_color_manual(values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 

p.neub <- ggplot(data=test, aes(x=time, y=Neuroblast_1, group=treat)) +
  geom_line(aes(col=treat), size=1.3) +
  theme_bw() + xlab('Days') + ylab('Cell Type Proportion') +
  ggtitle('Neuroblast') + theme(legend.position = 'none', axis.title=element_text(size=14), axis.text=element_text(size=12), plot.title=element_text(size=14)) +
  scale_color_manual(values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 

p.dummy <- ggplot(data=test, aes(x=time, y=Neuroblast_1, group=treat)) +
  geom_line(aes(col=treat)) + labs(color='Treatment') + 
  theme(legend.text=element_text(size=18), legend.title=element_text(size=18), legend.key=element_blank()) + 
  guides(color = guide_legend(override.aes = list(size = 5))) +
  scale_color_manual(labels=c('Control', 'Lead 5 μM', 'Lead 30 μM'), values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 
...
p.olig1 <- ggplot(data=gene.time, aes(x=time, y=OLIG1, group=treat)) +
  geom_line(aes(col=treat), size=1.3) +
  theme_bw() + xlab('Days') + ylab('TPM') +
  ggtitle('OLIG1') + theme(legend.position = 'none', axis.title=element_text(size=14), axis.text=element_text(size=12), plot.title=element_text(size=14)) +
  scale_color_manual(values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 

p.olig2 <- ggplot(data=gene.time, aes(x=time, y=OLIG2, group=treat)) +
  geom_line(aes(col=treat), size=1.3) +
  theme_bw() + xlab('Days') + ylab('TPM') +
  ggtitle('OLIG2') + theme(legend.position = 'none', axis.title=element_text(size=14), axis.text=element_text(size=12), plot.title=element_text(size=14)) +
  scale_color_manual(values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 
...
p.pdgfra <- ggplot(data=gene.time, aes(x=time, y=PDGFRA, group=treat)) +
  geom_line(aes(col=treat), size=1.3) +
  theme_bw() + xlab('Days') + ylab('TPM') +
  ggtitle('PDGFRA') + theme(legend.position = 'none', axis.title=element_text(size=14), axis.text=element_text(size=12), plot.title=element_text(size=14)) +
  scale_color_manual(values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 

p.mbp <- ggplot(data=gene.time, aes(x=time, y=MBP, group=treat)) +
  geom_line(aes(col=treat), size=1.3) +
  theme_bw() + xlab('Days') + ylab('TPM') +
  ggtitle('MBP') + theme(legend.position = 'none', axis.title=element_text(size=14), axis.text=element_text(size=12), plot.title=element_text(size=14)) +
  scale_color_manual(values=c("#FB6B6B", "#E53EFF", "#68B2FF")) 
...
tiff("F:/Drive/Misc/RNAseq/Pb_Hipp/Figure_6_MuSiC.tif", height=8, width=12, units="in", res=300)
...
pdf("F:/Drive/Misc/RNAseq/Pb_Hipp/Figure_6_MuSiC.pdf", height=8, width=12)
grid.arrange(fig_pred_plots[[1]], fig_pred_plots[[2]], fig_pred_plots[[3]],
             p.predleg, fig_pred_plots[[4]], fig_pred_plots[[5]], 
                        fig_pred_plots[[6]], fig_pred_plots[[7]],
             heights = c(1.5,1,1),
