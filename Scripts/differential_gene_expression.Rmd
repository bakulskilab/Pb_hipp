...
f3f <- ggplot(f3f.df,aes(x=cl0, y=cl1, col=d)) +
  ...
  xlab("Epithelial Lead Effect") + ylab("Microglia Lead Effect") +
...
fig_pred_plots <- list(p.opc, p.nipc, p.neub, p.olig1, p.olig2, p.olig3, p.mbp)
...
tiff("C:/Users/John/Google Drive/Misc/RNAseq/Pb_Hipp/Figure_4_DE_clust.tif", height=8, width=12, units="in", res=300)
